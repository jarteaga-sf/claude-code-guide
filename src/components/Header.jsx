...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-[56px] bg-[var(--color-header-bg)] text-white flex items-center justify-between px-6 shadow-md">
      ...
      <div className="flex items-center gap-5">
        <a
          href="https://sfdc.co/claude-code-support"
          target="_blank"
          rel="noopener noreferrer"
          className="hidden sm:flex items-center gap-1.5 text-[14px] text-white/80 hover:text-white transition-colors"
        >
          Technical Support
