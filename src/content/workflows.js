...
export const section6 = {
  ...
  features: [
    { shortcut: 'Tab', name: 'Autocomplete', description: 'Cursor sees your context and suggests the next line or block. Tab to accept, keep typing to ignore.' },
    { shortcut: 'Cmd+K', name: 'Inline Edit', description: 'Select a function, press Cmd+K, describe the change. Diff shown inline — accept or reject without leaving the file.' },
    { shortcut: 'Cmd+Shift+I', name: 'Composer', description: 'Multi-file changes from a single prompt. Shows diffs for each file before applying. Good for refactors and API migrations.' },
  ],
